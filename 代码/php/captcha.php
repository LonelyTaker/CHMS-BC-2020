<?php
  ...
  setcookie('pass_phrase',$pass_phrase);
  ...
  imagettftext($img, 18, 0, 5, CAPTCHA_HEIGHT - 5, $text_color, 'my_font.ttf', $pass_phrase);

  // Output the image as a PNG using a header
  //header("Content-type: image/png");
  // imagepng($img);
  imagepng($img, "../img/captcha.png");
  echo "img/captcha.png";
